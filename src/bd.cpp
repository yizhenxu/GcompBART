...
*/
//std X, di, ncov
bool bd(std::vector<std::vector<double> >& X, size_t ncov, tree& x, xinfo& xi, dinfo& di, pinfo& pi, size_t minobsnode, Rcpp::NumericVector& binaryX,
...
//std X, di, ncov
bool bd1(std::vector<std::vector<double> >& X, size_t ncov, tree& x, xinfo& xi, dinfo& di, pinfo& pi, size_t minobsnode, Rcpp::NumericVector& binaryX,
